...
def main():
    ...
    with open(output_file, "w") as f:
        f.write("Well1,Well2,HCC,PearsonCorr,LCC,CorrDiff,HighestCorrComp,LowestCorrComp,MeanCorr,StdCorr,MedianCorr,IQRCorr,WindowStart,WindowEnd,Observations\n")
